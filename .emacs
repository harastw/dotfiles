...
(custom-set-variables
 ...
 '(package-selected-packages
   '(helm-projectile projectile flycheck :lsp-ui company lsp orderless vertico consult use-package lsp-ui lsp-mode cmake-mode evil rust-mode lua-mode gruvbox-theme rainbow-mode sly)))
